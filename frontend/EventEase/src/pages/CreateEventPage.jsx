...
export default function CreateEventWizard({ onCancel, onCreate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Format dates to match your backend's expected TimeSlot payload format
    ...
    try {
      ...
      // Extract the admin and share tokens generated by the backend
      if (data.admin_token && data.share_token) {
        // ✅ FIXED: Point directly to your React Router client paths
        setAdminLink(`${window.location.origin}/admin/${data.admin_token}`);
